<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /theme/realestate/frontend/results_pagination.php
	# ----------------------------------------------------------------------------------------------------
    
    if ((!($array_pages_code["total"] <= $aux_items_per_page)) && (($showLetter || ($array_pages_code["total"] > $aux_items_per_page)) && !$hideResults)) { ?>
