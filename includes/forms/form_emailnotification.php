...
<table width="500" cellpadding="2" cellspacing="0" border="0" class="table-form">
	...
	<tr class="tr-form">
		...
		<td align="left" class="td-form">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td style="width:20px;"><input type="radio" name="content_type" value="text/plain" <?=(($content_type == "text/plain") ? "checked": "")?> style="width: auto; border: 0;" class="inputCheck" /></td>
					<td  style="width:40px;"><?=system_showText(LANG_SITEMGR_LABEL_TEXT)?></td>
					<td style="width:20px;"><input type="radio" name="content_type" value="text/html" <?=(($content_type == "text/html") ? "checked": "")?> style="width: auto; border: 0;" /></td>
	...
	<tr class="tr-form">
		...
		<td align="left" class="td-form">
			<input type="text" name="bcc" maxlength="255" size="35" value="<?=$bcc?>" />
		</td>
	</tr>	
