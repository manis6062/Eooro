...
<? if (THEME_LISTINGTEMPLATE_LAYOUTS) { ?>
...
<table border="0" cellpadding="2" cellspacing="0" class="standard-table">
	...
	<tr>
		<th colspan="4" class="standard-tabletitle wrap">
			<?=system_showText(LANG_SITEMGR_LISTINGTEMPLATE_SELECTCATEGORIES)?>
			<span>
				<?=system_showText(LANG_SITEMGR_LISTINGTEMPLATE_CATEGORYTIP)?>
			</span>
		</th>
	</tr>
...
<script language="javascript" type="text/javascript">
	loadCategoryTree('main', 'listing_', 'ListingCategory', 0, 0, '<?=DEFAULT_URL."/".EDIR_CORE_FOLDER_NAME."/".LISTING_FEATURE_FOLDER?>', '<?=SELECTED_DOMAIN_ID;?>');
</script>