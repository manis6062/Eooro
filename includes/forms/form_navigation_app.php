<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/forms/form_navigation_app.php
	# ----------------------------------------------------------------------------------------------------
...
?>
    ...
    <div class="form-right form-extended">
        ...
        <h4><?=system_showText(LANG_SITEMGR_BUILDER_CONFIGMENU)?></h4> <a class="float-right text-alert" href="javascript:void(0)" onclick="<?=DEMO_LIVE_MODE ? "livemodeMessage('".system_showText(LANG_SITEMGR_THEME_DEMO_MESSAGE2)."');" : "ResetNavigation();"?>"><?=system_showText(LANG_SITEMGR_BUILDER_RESETMENU);?></a>
        ...
        <div class="sortable-title">
            ...
            <span class="float-right"><?=system_showText(LANG_LABEL_DELETE)?></span>
        </div>
        ...
        <p><?=system_showText(LANG_SITEMGR_CONFIGURE_APP_STEP_1_TIP);?></p>
