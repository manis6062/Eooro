 ...
 */
$modules = array("currency", "item", "payment", "paypal", "simplepay", "creditcard", "pagseguro", "sagepay", "braintree"); //, "braintree"
...
<?
	...
	include(INCLUDES_DIR."/forms/form_paymentsettings_pagseguro.php");
        ...
        $sage->setTask('paymentsettings')->run();


    include(INCLUDES_DIR."/forms/form_paymentsettings_braintree.php");
?>
