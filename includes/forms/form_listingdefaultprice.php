...
<p class="informationMessage">
    ...
    <?="<br />&#149;&nbsp;".system_showText(LANG_CATEGORIES_CATEGORIESMAXTIP1)." ".system_showText(LISTING_MAX_CATEGORY_ALLOWED)." ".system_showText(LANG_CATEGORIES_CATEGORIESMAXTIP2)?>    
</p>
...
<table cellpadding="2" cellspacing="0" class="table-form" border="0">
	...
	foreach ($levelvalues as $levelvalue) {
		...
		<tr>
			...
			<td align="left" class="td-form">
				<input type="text" name="free_category[<?=$levelvalue?>]" class="input-form-listing" style="width:150px" value="<?=$levelObj->getFreeCategory($levelvalue)?>" maxlength="2" />
			</td>
			<td align="left" class="td-form">
				<input type="text" name="category_price[<?=$levelvalue?>]" class="input-form-listing" style="width:150px" value="<?=$levelObj->getCategoryPrice($levelvalue)?>" maxlength="8" />
			</td>
		</tr>
		<?
	}
