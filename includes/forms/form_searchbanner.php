	...
	<tr>
			...
			<td nowrap>
                ...
                <? if (PROMOTION_FEATURE == "on" && CUSTOM_PROMOTION_FEATURE == "on" && CUSTOM_HAS_PROMOTION == "on") { ?>
					<input type="radio" name="search_section" value="promotion" <? if ($search_section == "promotion") echo "checked"; ?> onclick="fillBannerCategorySelect('<?=DEFAULT_URL?>', this.form.search_category, this.value, this.form, <?=SELECTED_DOMAIN_ID?>, 'search');" class="inputAlign" /> <?=string_ucwords(system_showText(LANG_SITEMGR_PROMOTION))?>
				<? } ?>
                ...
                <? if (BLOG_FEATURE == "on" && CUSTOM_BLOG_FEATURE == "on") { ?>
					<input type="radio" name="search_section" value="blog" <? if ($search_section == "blog") echo "checked"; ?> onclick="fillBannerCategorySelect('<?=DEFAULT_URL?>', this.form.search_category, this.value, this.form, <?=SELECTED_DOMAIN_ID?>, 'search');" class="inputAlign" /> <?=string_ucwords(system_showText(LANG_SITEMGR_BLOG))?>
				<? } ?>    
