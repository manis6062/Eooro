...
?>
	...
	$body = str_replace("ACCOUNT_LOGIN_INFORMATION", system_showText(LANG_SITEMGR_EMAILNOTIFICATION_VAR_ACCOUNT_LOGIN_INFORMATION), $body);
        $body = str_replace("REVIEWCOLLECTOR_LOGIN_INFORMATION", system_showText(LANG_SITEMGR_EMAILNOTIFICATION_VAR_ACCOUNT_LOGIN_INFORMATION), $body);
	...
	<table cellpadding="0" cellspacing="2">
        <tr>
            <td>
                <span <?=$style_1?>><?=system_showText(LANG_SITEMGR_LABEL_FROM)?>: </span>
            </td>
            
            <td>
                <span <?=$style_2?>><?=$from?></span>
            </td>
        </tr>
        
        <tr>
            <td>
                <span <?=$style_1?>><?=system_showText(LANG_SITEMGR_LABEL_TO)?>:   </span>
            </td>
            <td>
                <span <?=$style_2?>><?=$to?></span>
            </td>
        </tr>
        
        <tr>
            <td>
                <span <?=$style_1?>><?=system_showText(LANG_SITEMGR_LABEL_BCC)?>:  </span>
            </td>
            <td>
                <span <?=$style_2?>><?=$bcc?></span>
            </td>
        </tr>
        
        <tr>
            <td>
                <span <?=$style_1?>><?=system_showText(LANG_SITEMGR_LABEL_SUBJECT)?>:  </span>
            </td>
            <td>
                <span <?=$style_2?>><?=$subject?></span>
            </td>
        </tr>
        
        <tr>
            <td colspan="2">
                <div style="overflow:auto; width: 510px; margin: 10px auto 0 auto; border: 1px solid #EEE;">
                    <?=$body?>
                </div>
            </td>
        </tr>
