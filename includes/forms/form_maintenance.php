<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/forms/form_maintenance.php
	# ----------------------------------------------------------------------------------------------------
...
?>
    ...
    <table cellpadding="2" cellspacing="0" border="0" class="table-form" width="100%">
        <tr>
            <td colspan="2">
                <div class="tip-base">
                    <span class="warning" style="text-align: justify; font-size: 11px;"><a href="<?=DEFAULT_URL;?>/<?=SITEMGR_ALIAS?>/faq/faq.php?keyword=<?=urlencode("maintenance");?>" target="_blank"><?=system_showText(LANG_SITEMGR_MAINTENANCETIP)?></a></span>
                </div>
            </td>
        </tr>
        <tr class="tr-form">
