...
<table border="0" cellpadding="0" cellspacing="0" class="levelTable">
	...
	<tr>
		<th class="tableOption" colspan="2"><a href="<?=NON_SECURE_URL?>/<?=ALIAS_ADVERTISE_URL_DIVISOR?>.php" target="_blank" class="listingOption"><?=system_showText(LANG_LISTING_OPTIONS);?></a></th>
	</tr>
	<? } ?>
	<tr>
				...
				<table border="0" cellpadding="2" cellspacing="2" class="standardChooseLevel">
					<? if (LISTINGTEMPLATE_FEATURE == "on" && CUSTOM_LISTINGTEMPLATE_FEATURE == "on" && !USING_THEME_TEMPLATE) { ?>
                        <tr>
                            ...
                            <td>
                            		<?=system_showText(LANG_BUSINESS);?>

                            	<? /*	SELECT LISTING TYPE
                                <select name="listingtemplate_id" size="2" style="width:500px">
                    ...
                    <? } ?>    
                        ...
                        $levelvalues = $levelObj->getLevelValues();
	                        foreach ($levelvalues as $levelvalue) {
	                            ?>
	                            <tr>
	                                <th class="listingLevel">Premium Plan<?/* <?=$levelObj->showLevel($levelvalue)?> */?></th>
		...
		<? } ?>
            ...
            <td class="levelPrice">
                <table border="0" cellpadding="2" cellspacing="2" class="standard-tableSAMPLE">
					...
					<?  
						$b = implode("", $strArray);
						echo str_replace("Diamond","Premium Plan",$b);
					?>
                    </tr>
                </table>
            </td>
