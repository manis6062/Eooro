	...
	<div id="pagseguro_setting">
		<table class="table-form table-form-paymentgateway">
            <tr>
                <td colspan="2">
                    <div class="tip-base">
                        <span class="warning" style="text-align: justify; font-size: 11px;"><a href="<?=DEFAULT_URL;?>/<?=SITEMGR_ALIAS?>/faq/faq.php?keyword=<?=urlencode("pagseguro");?>" target="_blank"><?=system_showText(LANG_SITEMGR_PAGSEGUROTIP)?></a></span>
                    </div>
                </td>
            </tr>
			<tr class="tr-form">
