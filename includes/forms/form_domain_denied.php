	...
	<div id="content-content">
		<div class="default-margin">
			<div class="baseForm">
				...
				<button type="button" name="back" class="input-button-form" value="Back" onclick="window.location = '<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/domain/index.php'"><?=system_showText(LANG_SITEMGR_BACK)?></button>
