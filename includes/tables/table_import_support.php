...
<tr>
    ...
    <td>
        <img style="cursor: pointer;" src="<?=DEFAULT_URL?>/images/icon_interrogation.gif" alt="?" title="<?=import_getLogTip($import->getString("status"), $import->getString("action"));?>" border="0">
    </td>
