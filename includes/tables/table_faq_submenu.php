...
<div class="submenu">
	<ul>
		<li id="privateMenu_faq"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/faq/faq.php"><?=system_showText(LANG_MENU_FAQ)?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/faq/search.php"><?=system_showText(LANG_SITEMGR_MENU_SEARCH)?></a></li>
	</ul>
</div>
