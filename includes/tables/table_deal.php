    ...
    <form name="item_table">
        <table class="table-itemlist">
            ...
            <tr>
                ...
                <th colspan="2">
                    <span><?=system_showText(LANG_LABEL_POSTED_ON);?></span>
                </th>
                <th>
                    <span><?=system_showText(LANG_LABEL_DATE);?></span>
                </th>
                <th>
                    <span><?=system_showText(DEAL_SITEMGR_REDEEMCODE);?></span>
                </th>
                <th>
            ...
            <?
                foreach ($dealsInfo as $info) {
                    ...
                    <tr>
                        <td>
                        <? if ($profileObj->getNumber("account_id") && string_strpos($url_base, "".SITEMGR_ALIAS."") !== false) { ?>
