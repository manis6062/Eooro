...
<div class="submenu">
	<ul>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/invoices/index.php"><?=system_showText(LANG_SITEMGR_MENU_HISTORY)?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/invoices/search.php"><?=system_showText(LANG_SITEMGR_MENU_SEARCH)?></a></li>
