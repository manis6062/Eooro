	...
	<div class="submenu">
		<ul>
			<li id="privateMenu_home">
				<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/package/index.php"><?=system_showText(LANG_SITEMGR_MANAGE)?></a>
			</li>
			<li id="privateMenu_add">
				<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/package/package.php"><?=system_showText(LANG_SITEMGR_MENU_ADD)?></a>
			</li>
			<li id="privateMenu_search">
				<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/package/search.php"><?=system_showText(LANG_SITEMGR_MENU_SEARCH)?></a>
			</li>
			<li id="privateMenu_reports">
				<a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/package/reports.php"><?=system_showText(LANG_SITEMGR_NAVBAR_REPORTS)?></a>
			</li>
