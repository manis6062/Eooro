...
?>
    ...
    <table class="table-itemlist">
        ...
        <tr>
            <th><?=system_showText(LANG_SITEMGR_SETTINGS_FAQ_QUESTION)?></th>
			<th><?=system_showText(LANG_SITEMGR_SETTINGS_FAQ_ANSWER)?></th>
            ...
            <? foreach ($faqs as $faq) { ?>
                <tr>
                    ...
                    <td nowrap class="main-options">
                        ...
                        <b>|</b>
                        <a href="javascript:void(0)" onclick="faq_showEdit(<?=$faq["id"]?>)">
                            <?=system_showText(LANG_LABEL_EDIT)?>
                        </a>
                        <b>|</b>
                        <a href="javascript:void(0)" onclick="dialogBox('confirm','<?=system_showText(LANG_SITEMGR_MSGAREYOUSURE);?>',<?=$faq['id']?>,'FAQ_post','','<?=system_showText(LANG_SITEMGR_OK);?>','<?=system_showText(LANG_SITEMGR_CANCEL);?>');">
                ...
                <tr id="FAQ_edit<?=$faq["id"]?>" style="display:none" class="hideForm">
                    <td colspan="4" id="FAQ_editTD<?=$faq["id"]?>" class="innerTable">
                        <form name="FAQ_edit" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/prefs/faq.php" method="post">
