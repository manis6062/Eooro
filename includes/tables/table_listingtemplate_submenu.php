...
<div class="submenu">
	<ul>
		<li><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/<?=LISTING_FEATURE_FOLDER;?>/index.php"><?=string_ucwords(system_showText(LANG_SITEMGR_MENU_LISTINGSHOME))?></a></li>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/listingtemplate/index.php"><?=system_showText(LANG_SITEMGR_MENU_LISTINGSTEMPLATESHOME)?></a></li>
		<li id="privateMenu_add"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/listingtemplate/template.php"><?=system_showText(LANG_SITEMGR_MENU_ADD)?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/listingtemplate/search.php"><?=system_showText(LANG_SITEMGR_MENU_SEARCH)?></a></li>
