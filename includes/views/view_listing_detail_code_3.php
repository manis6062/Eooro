        ...
        <div id="content_overview" class="tab-content">
            ...
            <div class="row-fluid">
                ...
                <div class="top-info">
                    ...
                    <h3 itemprop="name"><?=$listingtemplate_title?></h3>

                    <div class="row-fluid">

                        <div class="span8" <?=$listingtemplate_summary_review && count($reviewsArr) > 0 ? "itemprop=\"aggregateRating\" itemscope itemtype=\"http://schema.org/AggregateRating\"" : ""?>>
            ...
            <div class="row-fluid middle-info">
                ...
                <? if ($listingtemplate_image || $listingtemplate_gallery || $listingtemplate_long_description || $listingtemplate_designations) { ?>
                ...
                <div class="span7">
                   ...
                   <? if ($listingtemplate_gallery) { ?>
                    ...
                    <div <?=($onlyMain && !$isNoImage ? "class=\"detailfeatures\"" : "")?>></div>
                ...
                <div class="span5">
                    ...
                    <? if (($listingtemplate_address) || ($listingtemplate_address2) || ($listingtemplate_location) || ($listingtemplate_features) ) { ?>
            ...
            <? if ($listingtemplate_hours_work || $listingtemplate_locations) { ?>
