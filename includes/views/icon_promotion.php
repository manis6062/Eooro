<?
	...
	if (SOCIAL_BOOKMARKING == "on") {
        if (string_strpos($_SERVER['REQUEST_URI'], ALIAS_PROMOTION_MODULE."/".ALIAS_REVIEW_URL_DIVISOR."/") !== false) {
            ...
            $sbmLinkShare = PROMOTION_DEFAULT_URL."/".ALIAS_REVIEW_URL_DIVISOR."/".ALIAS_SHARE_URL_DIVISOR."/".$promotion->getString("friendly_url");
        } else {
            $sbmLink = PROMOTION_DEFAULT_URL."/".$promotion->getString("friendly_url");
            $sbmLinkShare = PROMOTION_DEFAULT_URL."/".ALIAS_SHARE_URL_DIVISOR."/".$promotion->getString("friendly_url");
        }
	...
	if (SOCIAL_BOOKMARKING == "on"){
		...
		$icon_navbar .= "<li class=\"icon\"><a rel=\"nofollow\" ".$twitter." >".$twitter_imgE."</a></li>";
		$icon_navbar .= "<li class=\"icon\"><a rel=\"nofollow\" ".$facebook." >".$facebook_imgE."</a></li>";
		$icon_navbar .= "</ul>";
	}
