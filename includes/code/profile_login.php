<?
	...
	} elseif (string_strpos($_SERVER["HTTP_REFERER"], "/results.php") !== false) {
		$ItemPath = "/";
	} elseif (string_strpos($_SERVER["HTTP_REFERER"], str_replace(NON_SECURE_URL, "", DEFAULT_URL."/".ALIAS_BESTOF_URL_DIVISOR)) !== false) {
		$ItemPath = str_replace(NON_SECURE_URL, "", DEFAULT_URL."/".ALIAS_BESTOF_URL_DIVISOR)."/";
	} 
