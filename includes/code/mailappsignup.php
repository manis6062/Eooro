<?
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if ($disconnet == "yes") {
            ...
            header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".MAILAPP_FOLDER."/index.php?messageDisconnect=1#account");
            exit;
		...
		if (validate_form("mailapp_signup", $_POST, $message_mailapp)) {
            ...
            if ($actionForm == "newAcc") {
                ...
                if ($return["success"] == 1 && ($return["customer_ID"] || $return["arrayReturn"]["customer_ID"])) {
                    ...
                    header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".MAILAPP_FOLDER."/index.php?".($account_type == "existing" ? "messageConnect" : "messageSignup")."=1#account");
                    exit;
            ...
            //Create or update list
                ...
                if ($edir_list_id) {
                    ...
                    header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".MAILAPP_FOLDER."/index.php?messageUpdate=1#newsletter");
                    exit;
                ...
                //Create list
                    ...
                    if ($return["success"] == 1) {
                        ...
                        header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".MAILAPP_FOLDER."/index.php?messageNewList=1#newsletter");
                        exit;
