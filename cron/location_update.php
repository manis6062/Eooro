...
<?
    ...
    include_once(EDIRECTORY_ROOT."/functions/cache_funct.php");
	...
	if (mysql_num_rows($resDomain) > 0) {
        ...
        log_addCronRecord($link, "location_update", $messageLog, false, $cron_log_id);
	...
	if (!setting_set("last_datetime_location_update", date("Y-m-d H:i:s"))) {
		if (!setting_new("last_datetime_location_update", date("Y-m-d H:i:s"))) {
            ...
            log_addCronRecord($link, "location_update", $messageLog, true, $cron_log_id);
		}
	}
    $messageLog = "Cron finished";
    log_addCronRecord($link, "location_update", $messageLog, true, $cron_log_id, true, round($time, 2));
	////////////////////////////////////////////////////////////////////////////////////////////////////
?>