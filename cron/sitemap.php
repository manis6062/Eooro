...
#<?php
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	 $sqlDomain = "	SELECT
					...
					ORDER BY
						...
						CC.`last_run_date`,
						D.`id`
					LIMIT 1";//Checks the last time sitemap was run through this query :
	...
	if (mysql_num_rows($resDomain) > 0) {
		...
		exit;//and if the result is greater than 1, it proceeds further, else stops cron
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    include_once(FUNCTIONS_DIR."/sitemap_us.php");
