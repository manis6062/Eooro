                ...
                if ($row["error"] == "n") {
                    ...
                    if ($row["listing_title"]) {
                        ...
                        if ($needToUpdate){
                            ...
                            $sqlListing .= "seo_title = ".db_formatString(($row["listing_seo_title"] ? $row["listing_seo_title"] : $row["listing_title"]), "", true).", ";
                            if ($import_update_friendlyurl == "y") {
                            ...
                            $sqlListing .= "seo_description = ".db_formatString(($row["listing_seo_description"] ? $row["listing_seo_description"] : $row["listing_description"]), "", true).", ";
                            ...
                            $sqlListing = "INSERT INTO Listing (account_id,
                                                                ...
                                                                (".db_formatNumber($account_id).",
                                                                    ...
                                                                    ".db_formatString(($row["listing_seo_title"] ? $row["listing_seo_title"] : $row["listing_title"]), "", true).",
                                                                    ...
                                                                    ".db_formatString(($row["listing_seo_description"] ? $row["listing_seo_description"] : $row["listing_description"]), "", true).",
