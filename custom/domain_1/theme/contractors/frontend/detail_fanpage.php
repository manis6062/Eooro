<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /theme/contractors/frontend/detail_fanpage.php
	# ----------------------------------------------------------------------------------------------------
    ...
    if ($listingtemplate_fbpage) { ?>
        ...
        <script language="javascript" type="text/javascript">
            ...
            document.write('<div class="fb-like-box" data-href="<?=$listingtemplate_fbpage?>" data-width="300" data-show-faces="true" data-stream="true" data-header="true"></div>');
            //]]>
        </script>
