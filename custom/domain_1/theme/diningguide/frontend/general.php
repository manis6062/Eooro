<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /theme/diningguide/frontend/general.php
	# ----------------------------------------------------------------------------------------------------
    ...
    if (string_strpos($page, $alias_allcategories) !== false) {
        ...
        if ($module_name == "listing") {
            
            /**
             * Create variables to paginate
             */
            if (!isset($category_page)) {
                $category_page = 1;
            }
            $filePathToInclude = system_getFrontendPath("bycuisine.php", "frontend", false, $moduleFolder);
        } else {
        ...
        $filePathToInclude = EDIRECTORY_ROOT."/includes/forms/form_faq.php";
    } else {
        ...
        if (string_strpos($_SERVER["REQUEST_URI"], ALIAS_BESTOF_URL_DIVISOR) !== false) {
            $filePathToInclude = system_getFrontendPath("bestof.php", "frontend", false);
        } elseif (file_exists(EDIRECTORY_ROOT."/".$generalPageItemPath.$page."content.php")) {
