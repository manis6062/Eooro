<?
    ...
    if($row["active"] == "n"){
        ...
        echo '<section class="welcome-box">
        ...
        echo "<strong>";
        echo "Your account is not validated, please validate it now.<br /> No reviews will be shown from unvalidated accounts.";
        echo "</strong>";
        echo "</div>";
    }
...
?>
    ...
    <article>
        ...
        <section class="welcome-box">
            ...
            <!-- modification see frontend/user_activity for default  -->
        ...
        <section class="activity-box">
            ...
            <section class="item-activity" id="activity_<?=$countItem?>" <?=$countItem > $maxActs ? "style=\"display:none;\"" : ""?>>
                ...
                <? } elseif (string_strpos($key, "review") !== false) { ?>
                    ...
                    <p><b><?=  ucwords($activity["review_title"])?></b></p>
