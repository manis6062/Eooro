...
<section class="latest-review">
    <div class="container">
        ...
        <? $review_title = ucwords($featureReview["review_title"]);
           $review_title1 = ucwords($featureReview["review_title"]);
                    ...
                    <div class="thumbnail fixedheight" itemscope itemtype="http://schema.org/Review" >
                        ...
                        <div class="abc">
                           ...
                           <div itemprop="itemReviewed" itemscope itemtype="http://schema.org/LocalBusiness">     
                            <h4 itemprop="name">
                                <a href="<?=$featureReview['detailItemLink']?>">
                                    <em><?=stripcslashes(ucwords($featureReview["title"]));?></em>
                                </a>
                            </h4>
                           </div> 
                         ...
                         <span class="text" itemprop="name">
                            ...
                            if($review_len>47){
                                $review_title1 = system_showTruncatedText($review_title,44, false, true);
                                ?>
                            <span data-toggle="tooltip" data-placement="bottom" title="<?=($review_title)?>">
                                <strong> <?=($review_title1);?> </strong>
                            </span>
                            <?} else{?>
                             <span title="">
