<?
    ...
    <? } ?>
    <!-- modifications -->
    <link href="<?=THEMEFILE_URL;?>/<?=EDIR_THEME;?>/sstyle.css" rel="stylesheet" type="text/css" media="all" />
    ...
    <? if ((defined("ACTUAL_MODULE_FOLDER") && ACTUAL_MODULE_FOLDER != "")) { ?>
        ...
        <link rel="stylesheet" type="text/css" href="<?=THEMEFILE_URL?>/<?=EDIR_THEME;?>/jquery.ad-gallery.css"/>
    <? } ?>
