    ...
    <!-- [if false]><body><![endif]-->
        ...
        <div class="navbar navbar-static-top">
            ...
            <div class="header-brand container">
                ...
                <div id="user-location" class="user-location">
                    <div id="country-selector" class="location-select">
                        <? include(system_getFrontendPath('country_dropdown.php')); ?>
                    </div>
                    <div id="state-selector" class="location-select">
             ...
             <div class="navbar-inner">
                ...
                <div class="container">
                    ...
                    <? } ?>
                    <!--<a class="btn btn-navbar" data-toggle="collapse" data-target=".country-collapse" onclick="collapseMenu('country')"><span>country</span></a>-->
...
//                        } ?>
                    ...
                    <div id="country-collapse" class="country-collapse collapse">
                        <?// include(system_getFrontendPath('country_dropdown.php')); ?>
                    </div>
                    -->
                </div>
