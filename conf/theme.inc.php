<?
	...
	$edir_themes = "default,realestate,diningguide,contractors,stremline,review";
	$edir_themenames = "eDirectory Default,Real Estate,Dining Guide,Contractors,Stremline,Review";
