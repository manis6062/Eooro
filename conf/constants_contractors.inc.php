<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /conf/constants_contractors.inc.php
	# ----------------------------------------------------------------------------------------------------
    ...
    define("IMAGE_THEME_BACKGROUND_H", 370);
    ...
    define("FANCYBOX_FRONT_PREVIEW_HEIGHT",   500);
    ...
    define("FEATURED_LISTING_MAXITEMS_SPECIAL", 0);
    ...
    define("FEATURED_EVENT_MAXITEMS", 4);
    
    # FEATURED EVENT - SPECIAL ITEMS
    define("FEATURED_EVENT_MAXITEMS_SPECIAL", 0);
    ...
    define("THEME_FAVORITES_BUTTON", true);
    
    # CONTACT US INFORMATION
    define("THEME_CONTACTUS_FIELDS", true);
    
    # HOME PAGE SPECIAL FIELDS
    define("THEME_HOMEPAGE_FIELDS", true);
    ...
    # TWITTER WIDGET SIZE
    define("TWITTER_WIDGET_WIDTH", "315");
    define("TWITTER_WIDGET_HEIGHT", "400");
    define("TWITTER_WIDGET_COLOR", "33b5e5");
    ...
    $array_navigation["header"][] = array("name" => LANG_MENU_ENQUIRE2, "url" => "ALIAS_LEAD_URL_DIVISOR");
