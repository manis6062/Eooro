<?php
	//set default scheme
	$edir_default_scheme = "stremline";

	//set all available schemes separated by comma
	$edir_schemes = "stremline";
	$edir_schemenames = "Stremline";

	//code to setup one specific scheme from all available schemes
	$edir_scheme = "stremline";

	if (DEMO_LIVE_MODE == 0) {
		@include_once(EDIRECTORY_ROOT.'/custom/domain_'.SELECTED_DOMAIN_ID.'/theme/stremline_scheme.inc.php');
	} else {
