<?
    ...
    <div class="real-steps">
        ...
        <ul class="standardStep steps-3">
            <li class="steps-ui stepActived stepLast"><span>3</span>&nbsp;<?=system_showText(LANG_LABEL_CHECKOUT)?></li>
            <li class="steps-ui" ><span>2</span>&nbsp;<?=system_showText(LANG_LISTING_UPDATE);?></li>
        ...
        <div>
            ...
            <? } else { ?>
                ...
                if ($emailNotificationObj = system_checkEmail(SYSTEM_INVOICE_NOTIFICATION)) {
                    ...
                    system_mail($contact->getString("email"), $subject, $body, EDIRECTORY_TITLE." <$sitemgr_email>", $emailNotificationObj->getString("content_type"), "", $emailNotificationObj->getString("bcc"), $error, "", "", "", $listing->id, $contact->account_id, SYSTEM_INVOICE_NOTIFICATION);
                }
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="standard-table">
                    ...
                    <tr>
                        ...
                        <td><p class="warningBOXtext"><strong><?=EDIRECTORY_TITLE?></strong></p></td>
                    </tr>
                    <tr>
                        <th>&nbsp;</th>
                        <td>
