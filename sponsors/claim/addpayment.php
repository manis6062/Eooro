<?
	...
	<div class="content content-full">
        <h2 style="display:none;"><?=system_showText(LANG_MSG_CLAIM_THIS_LISTING)?></h2>

        <div>

            <h2 style="display:none;"><?=system_showText(LANG_MENU_MAKEPAYMENT)?></h2>
...
if ($payment_tax_status == "on") { 
    	$tax_amount = payment_calculateTax($bill_info["total_bill"], $payment_tax_value, true, false);
    	$bill_info['tax_amount'] = $payment_tax_value;
   }
