		...
		function getCodeOfPagination($array_pages, $aux_page_url, $aux_url = false, $force_total = false, $jsFunct = "") {
			...
			if ($array_pages["show_pages"]) {
				...
				if ($array_pages["pages"]["previous"] != $this->aux_page_num) {
                    ...
                    if (!$jsFunct) {
                        $array_links["previous"] = "<li><a ".(!THEME_PAGINATION_USELABEL ? "title=\"".system_showText(LANG_PAGING_PREVIOUSPAGEMOBILE)."\"" : "")." href='".$aux_page_url.$array_pages["pages"]["previous"].($aux_url ? $aux_url : "")."'>".(THEME_PAGINATION_USELABEL ? system_showText(LANG_PAGING_PREVIOUSPAGEMOBILE) : "&laquo;")."</a></li>";
				...
				if ($array_pages["pages"]["next"] != $this->aux_page_num) {
                    ...
                    if (!$jsFunct) {
                        $array_links["next"] = "<li><a ".(!THEME_PAGINATION_USELABEL ? "title=\"".system_showText(LANG_PAGING_NEXTPAGEMOBILE)."\"" : "")." href='".$aux_page_url.$array_pages["pages"]["next"].($aux_url ? $aux_url : "")."'>".(THEME_PAGINATION_USELABEL ? system_showText(LANG_PAGING_NEXTPAGEMOBILE) : "&raquo;")."</a></li>";
