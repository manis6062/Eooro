		...
		<div class="default-margin">
			...
			<? if (!$rollback) { ?>
				...
				<div class="baseForm">
					...
					<form action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/import/rollback.php" method="post">				
					...
					<form id="formimportrollbakccancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/import/importlog.php?import_type=<?=$import_type?>" method="post">
					</form>
			...
			<? } else { ?>
				...
				<div class="baseForm">
					<form action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/import/importlog.php?import_type=<?=$import_type?>" method="post">
