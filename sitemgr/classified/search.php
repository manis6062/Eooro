<?
	...
	************************************************/
	...
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/".CLASSIFIED_FEATURE_FOLDER."/search.php";
    $manageOrder = system_getManageOrderBy($_POST["order_by"] ? $_POST["order_by"] : $_GET["order_by"], "Classified", CLASSIFIED_SCALABILITY_OPTIMIZATION, $fieldsManage, true);
	...
	$pageObj  = new pageBrowsing("Classified", $screen, RESULTS_PER_PAGE, $manageOrder, "title", $letter, $where, $fieldsManage);
