<?
	...
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		if (($id) && ($classified)) {
			...
			header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".CLASSIFIED_FEATURE_FOLDER."/classified.php?level=".$_POST['level']);
			exit;
		}
	}
...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<form id="formclassifiedlevelcancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/<?=CLASSIFIED_FEATURE_FOLDER;?>/<?=(($search_page) ? "search.php" : "index.php");?>" method="post">
