    ...
    <div id="main-right">
        ...
        <div id="top-content">
            <div id="header-content">
                <h1><?=string_ucwords(system_showText(LANG_SITEMGR_BLOG))?> - <?=$_GET["id"] ? system_showText(LANG_SITEMGR_EDIT) : string_ucwords(system_showText(LANG_SITEMGR_ADD));?> <?=string_ucwords(system_showText(LANG_SITEMGR_CATEGORY))?></h1>
            </div>
        </div>
        ...
        <div id="content-content">
            <div class="default-margin">
                ...
                <form name="category" id="category" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post" enctype="multipart/form-data">
                    ...
                    <button type="button" name="cancel" value="Cancel" class="input-button-form" onclick="document.getElementById('formblogcategorycancel').submit();"><?=system_showText(LANG_SITEMGR_CANCEL)?></button>

                </form>
                    
                <form id="formblogcategorycancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/blogcategs/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
