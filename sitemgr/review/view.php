        ...
        <div id="content-content">
            ...
            <div class="default-margin">
                ...
                <ul class="list-view">
                    ...
                    <li>
                        <a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/review/delete.php?id=<?=$each_rate->getNumber("id")?>&item_type=<?=$each_rate->getNumber("item_type")?>&item_id=<?=$item_id?><?=($filter_id ? "&filter_id=1" : '')?>&screen=<?=$screen?>&letter=<?=$letter?>&item_screen=<?=$item_screen?>&item_letter=<?=$item_letter?>" class="link-view"><?=system_showText(LANG_SITEMGR_REVIEW_DELETEREVIEW)?></a>
                    </li>
                </ul>
