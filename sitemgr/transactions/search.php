<?
    ...
    $paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/transactions/search.php";
    ...
    <div id="main-right">
        ...
        <div id="content-content">
            <div class="default-margin">
                ...
                <? } elseif ($back == "search" || string_strpos($_SERVER["PHP_SELF"], "transactions")) { ?>

                    <div class="header-form">
                        <?=string_ucwords(system_showText(LANG_SITEMGR_MENU_SEARCH))?>
                    </div>
                        
                    <form name="transactions" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="get" id="search_transaction_form">
