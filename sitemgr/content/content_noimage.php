        ...
        <div id="content-content">
            ...
            <div class="default-margin">
                ...
                <div class="tip-base"><p style="text-align: left;">
                    <a href="<?=DEFAULT_URL;?>/<?=SITEMGR_ALIAS?>/faq/faq.php?keyword=<?=urlencode("default image");?>" target="_blank"><?=system_showText(LANG_SITEMGR_CONTENT_FAQTITLE)?></a></p>
                </div>
                ...
                <div class="baseForm">
                    ...
                    <form id="formcontentnoimagecancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/index.php" method="post">
                    </form>
