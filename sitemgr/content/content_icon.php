        ...
        <div id="content-content">
            ...
            <div class="default-margin">
                ...
                <div class="tip-base"><p style="text-align: left;">
                    <a href="<?=DEFAULT_URL;?>/<?=SITEMGR_ALIAS?>/faq/faq.php?keyword=<?=urlencode("favicon");?>" target="_blank"><?=system_showText(LANG_SITEMGR_CONTENT_FAQICON)?></a></p>
                </div>
                ...
                <form id="formcontentfaviconcancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/index.php" method="post">
                </form>
