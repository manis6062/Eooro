<?
	...
	************************************************/
    ...
    $manageOrder = system_getManageOrderBy($_POST["order_by"] ? $_POST["order_by"] : $_GET["order_by"], "Event", EVENT_SCALABILITY_OPTIMIZATION, $fieldsManage, true);
    
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/".EVENT_FEATURE_FOLDER."/search.php";
	...
	$pageObj = new pageBrowsing("Event", $screen, RESULTS_PER_PAGE, $manageOrder,"title", $letter, $where, $fieldsManage);
