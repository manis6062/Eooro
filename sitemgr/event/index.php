<?
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("Event", $screen, RESULTS_PER_PAGE, ($_GET["newest"] ? "id DESC" : $manageOrder), "title", $letter, false, $fields);
	$events = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/".EVENT_FEATURE_FOLDER."/index.php";
