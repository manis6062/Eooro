<?
	...
	$url_redirect = "".DEFAULT_URL."/".SITEMGR_ALIAS."/locations/location_1/index.php";
	...
	if ($id) {
		...
		header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/locations/location_1/index.php?message=".$message."&screen=$screen&letter=$letter");
		exit;
	}
    ...
    <div id="main-right">
        ...
        <div id="content-content">
            <div class="default-margin">
                ...
                <form id="formlocation1deletecancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/locations/location_1/index.php?operation=cancel" method="post">
