        ...
        <div class="default-margin">
            ...
            <div class="baseForm">
                ...
                <form name="facebook_form" id="facebook_form" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post">
                    ...
                    <?
                    $detailLink = ARTICLE_DEFAULT_URL."/".ALIAS_SHARE_URL_DIVISOR."/".$article->getString("friendly_url");
                ...
                <form id="formfacebookcancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/<?=ARTICLE_FEATURE_FOLDER;?>/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
