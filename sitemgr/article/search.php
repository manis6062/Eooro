...
//	elseif ($search_account_id) $sql_where[] = " account_id = $search_account_id ";
    ...
    $manageOrder = system_getManageOrderBy($_POST["order_by"] ? $_POST["order_by"] : $_GET["order_by"], "Article", ARTICLE_SCALABILITY_OPTIMIZATION, $fieldsManage, true);

	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/".ARTICLE_FEATURE_FOLDER."/search.php";
	...
	$pageObj = new pageBrowsing("Article", $screen, RESULTS_PER_PAGE, $manageOrder, "title", $letter, $where, $fieldsManage);
