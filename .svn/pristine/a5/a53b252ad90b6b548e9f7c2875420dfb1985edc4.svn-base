<?php
	...
	if ($_GET["url_full"] && (string_strpos($_GET["url_full"], ALIAS_BLOG_MODULE."/".ALIAS_CATEGORY_URL_DIVISOR) !== false || string_strpos($_GET["url_full"], ALIAS_BLOG_MODULE."/".ALIAS_ARCHIVE_URL_DIVISOR) !== false)) {

		$url = string_replace_once(EDIRECTORY_FOLDER."/".ALIAS_BLOG_MODULE."/", "", $_GET["url_full"]);
		$parts = explode("/", $url);

		if (string_strpos($_GET["url_full"], ALIAS_BLOG_MODULE."/".ALIAS_CATEGORY_URL_DIVISOR) !== false){
		...
		} else if (string_strpos($_GET["url_full"], ALIAS_BLOG_MODULE."/".ALIAS_ARCHIVE_URL_DIVISOR) !== false){
			$browsebydate = true;
