<?
	...
	if ($front_featured_listings) {
        ...
        //Special Listing
        $firstListing_detailLink = "".LISTING_DEFAULT_URL."/".$featured_listing_Special["friendly_url"];
                    ...
                    <li>
                        <div class="listing-item">
                            ...
                            <div class="right">
                                ...
                                <p class="desc"><?=system_showTruncatedText($featured_listing_Special["description"], 110)?></p>
		...
		<h2>
			...
			<a rel="canonical" class="view-more" href="<?=LISTING_DEFAULT_URL?>"><?=$seeAllText;?></a>
		</h2>
		...
		<div class="featured featured-listing">
			...
			foreach ($front_featured_listings as $listing) {
				...
				$detailLink = "".LISTING_DEFAULT_URL."/".$listing["friendly_url"];
				...
				echo "<p class=\"description\">".system_showTruncatedText($listing["description"], 105)."</p>";
