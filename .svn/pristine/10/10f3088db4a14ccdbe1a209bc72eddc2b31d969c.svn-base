...
<div class="submenu">
	<ul>
		<li id="privateMenu_listing"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/review/index.php?item_type=listing"><?=system_showText(LANG_SITEMGR_LISTINGREVIEWS)?></a></li>
		<? if (ARTICLE_FEATURE == "on" && CUSTOM_ARTICLE_FEATURE == "on") { ?>
		<li id="privateMenu_article"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/review/index.php?item_type=article"><?=system_showText(LANG_SITEMGR_ARTICLEREVIEWS)?></a></li>
		<? } ?>
        <? if (PROMOTION_FEATURE == "on" && CUSTOM_PROMOTION_FEATURE == "on") { ?>
		<li id="privateMenu_promotion"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/review/index.php?item_type=promotion"><?=system_showText(LANG_SITEMGR_PROMOTIONREVIEWS)?></a></li>
        <? } ?>
	</ul>
</div>
