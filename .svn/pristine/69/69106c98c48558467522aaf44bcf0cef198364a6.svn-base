<?
	...
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/blogcategs/index.php?category_id=".$category_id;
...
<div id="main-right">
	...
	<div id="top-content">
		<div id="header-content">
			<h1><?=string_ucwords(system_showText(LANG_SITEMGR_BLOG_SING))?> - <?=string_ucwords(system_showText(LANG_CATEGORY_PLURAL))?></h1>
		</div>
	</div>
