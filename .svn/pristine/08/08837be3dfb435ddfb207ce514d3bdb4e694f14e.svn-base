<?
	...
	if (strpos($_SERVER["HTTP_HOST"], "demodirectory.com.br") !== false) {
        ...
        if (strpos($_SERVER["HTTP_HOST"], "guiaderestaurante") !== false) {
            
            $idIOS = "662285138";
            $idAndroid = "com.arcasolutions.apps.diningguide.br";
    ...
    //demodirectory US
        ...
        if (strpos($_SERVER["HTTP_HOST"], "diningguide") !== false) {
            
            $idIOS = "661864250";
            $idAndroid = "com.arcasolutions.apps.diningguide";
