...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<form name="classified" method="post" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>">
			...
			<form id="formclassifieddeletecancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/<?=CLASSIFIED_FEATURE_FOLDER;?>/<?=(($search_page) ? "search.php" : "index.php");?>" method="post">
