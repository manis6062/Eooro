<?
	...
	class ItemStatus {
		...
		function ItemStatus() {
			$this->default = "P";
			$this->value = Array("A", "S", "E", "P");
			$this->name = Array(system_showText(LANG_LABEL_ACTIVE), system_showText(LANG_LABEL_SUSPENDED), system_showText(LANG_LABEL_EXPIRED), system_showText(LANG_LABEL_PENDING));
			$this->style = Array("status-active", "status-suspended", "status-expired", "status-pending");
		}
