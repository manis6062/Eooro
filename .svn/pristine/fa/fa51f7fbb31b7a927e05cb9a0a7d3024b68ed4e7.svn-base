<?
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("Post", $screen, RESULTS_PER_PAGE, ($_GET["newest"] ? "id DESC" : $manageOrder), "title", $letter, false, $fields);
	$posts = $pageObj->retrievePage();
	
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/".BLOG_FEATURE_FOLDER."/index.php";
...
<div id="main-right">
	<div id="top-content">
		<div id="header-content"><h1><?=string_ucwords(system_showText(LANG_SITEMGR_BLOG_SING))?></h1></div>
	</div>
