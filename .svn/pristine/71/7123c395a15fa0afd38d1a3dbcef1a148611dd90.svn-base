...
//			$expire_date = format_date($expire_date);
			...
			$message = 2;
			header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/discountcode/index.php?screen=$screen&letter=$letter&message=".$message);
			exit;
		}
	}
		...
		<div id="content-content">
			<div class="default-margin">
				...
				<div class="baseForm">
					...
					<form id="formdiscountcodesettingscancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/discountcode/index.php" method="post">
						<input type="hidden" name="letter" value="<?=$letter?>" />
						<input type="hidden" name="screen" value="<?=$screen?>" />
					</form>
				</div>
