<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /controller/deal/review.php
	# ----------------------------------------------------------------------------------------------------
    ...
    $paging_url = PROMOTION_DEFAULT_URL."/".ALIAS_REVIEW_URL_DIVISOR;
    $aux = str_replace(EDIRECTORY_FOLDER."/".ALIAS_PROMOTION_MODULE."/".ALIAS_REVIEW_URL_DIVISOR."/", "", $_GET["url_full"]);
