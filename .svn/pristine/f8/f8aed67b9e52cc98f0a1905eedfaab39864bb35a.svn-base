            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-9 col-lg-9">
                        <ul class="footerMenu">
                            <li><a href="<?=NON_SECURE_URL?>">Home</a>
                            <?php if( $advertise ){ ?>
                            <li><a href="<?=NON_SECURE_URL?>/<?=ALIAS_ADVERTISE_URL_DIVISOR?>.php">Reviews</a>
                            <?php } ?>
                            <li><a rel="canonical" href="<?=LISTING_DEFAULT_URL?>/">Reviews</a>
                            <li><a href="<?=NON_SECURE_URL?>/<?=ALIAS_SITEMAP_URL_DIVISOR?>.php">Sitemap</a>
                            <li><a href="<?=BLOG_URL?>">Blog</a>
                            <li><a href="<?=NON_SECURE_URL?>/<?=ALIAS_CONTACTUS_URL_DIVISOR?>.php">Contact Us</a>
                            <li><a rel="canonical" href="<?=LISTING_DEFAULT_URL."/"."locations"?>">
                                View Locations
                                </a>
                            <li><a href="<?=NON_SECURE_URL?>/<?=ALIAS_FAQ_URL_DIVISOR?>.php">FAQ</a>
                            <li><a href="<?=NON_SECURE_URL?>/privacypolicy.php">Privacy Policy</a>
                            <li><a href="<?=NON_SECURE_URL?>/termsofuse.php">Terms of Use</a>
