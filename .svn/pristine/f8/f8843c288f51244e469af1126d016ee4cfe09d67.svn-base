<?
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["settings"]) {
		...
		header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/prefs/visitorprofile.php?s=".$snStatus);
		exit;
	}
...
<div id="main-right">
	...
	<div id="content-content">
		<div class="default-margin">
			...
			<p><b><?=system_showText(LANG_SITEMGR_SN_MSG_CONFIGURE);?></b></p><br>
			...
			<? if (SOCIALNETWORK_FEATURE == "on") { ?>
				<p><b><?=system_showText(LANG_SITEMGR_SN_MSG_CHANGE_SOCIAL_SETTINGS);?></b></p><br>
				<p>
