<?
	...
	$url_redirect = "".DEFAULT_URL."/".SITEMGR_ALIAS."/emailnotifications";
    ...
    if (!THEME_EMAIL_TOFRIEND) {
        $where = " id != ".SYSTEM_EMAIL_TOFRIEND;
    } else {
        $where = false;
    }
	$pageObj  = new pageBrowsing("Email_Notification", $screen, 100, "id", "id", $letter, $where);
	$emails = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/emailnotifications/index.php";
