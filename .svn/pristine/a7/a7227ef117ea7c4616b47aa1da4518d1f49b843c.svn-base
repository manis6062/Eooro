...
?>
    ...
    <div class="help-page">
        ...
        <h1 class="page-title text-center"><?=system_showText(LANG_LABEL_HELP)?></h1>
		...
		<div class="row-fluid form-encourage">
			...
			<form name="help" method="post" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>">
	            ...
	            <div class="row-fluid action text-center">
	                 <button class="btn btn-big btn-success" type="submit"><?=system_showText(LANG_BUTTON_SEND)?></button>
	            </div>
