<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /sitemgr/blog/comments/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/".BLOG_FEATURE_FOLDER."/comments/index.php?reply_id=$reply_id&item_id=$item_id".($filter_id ? "&filter_id=1" : '')."&item_screen=$item_screen&item_letter=$item_letter";
