<?
	...
	if ($r && mysql_num_rows($r)>0) {
		...
		<table class="table-itemlist">
			...
			<tr>
				<th colspan="3"><span class="viewAllItems"><?=((mysql_num_rows($r)>5) ? "<a href='".DEFAULT_URL."/".SITEMGR_ALIAS."/".LISTING_FEATURE_FOLDER."/search.php?search_account_id=".$id."&search_submit=Search'>".ucfirst(system_showText(LANG_SITEMGR_MORE))." ".string_ucwords(system_showText(LANG_SITEMGR_LISTING_PLURAL))." &raquo;</a>" : "")?></span><?=string_ucwords(system_showText(LANG_SITEMGR_LISTING_PLURAL));?></th>
			</tr>
			...
			while (($listing = mysql_fetch_assoc($r)) && ($count<5)) {
				...
				$listing_link = DEFAULT_URL."/".SITEMGR_ALIAS."/".LISTING_FEATURE_FOLDER."/view.php?id=".$listing["id"];
				?>
				<tr>
	...
	if (EVENT_FEATURE == "on" && CUSTOM_EVENT_FEATURE == "on") {
		...
		if ($r && mysql_num_rows($r)>0) {
			...
			<table class="table-itemlist">
				...
				<tr>
					<th colspan="3"><span class="viewAllItems"><?=((mysql_num_rows($r)>5) ? "<a href='".DEFAULT_URL."/".SITEMGR_ALIAS."/".EVENT_FEATURE_FOLDER."/search.php?search_account_id=".$id."&search_submit=Search'>".ucfirst(system_showText(LANG_SITEMGR_MORE))." ".system_showText(LANG_SITEMGR_NAVBAR_EVENT)." &raquo;</a>" : "")?></span><?=system_showText(LANG_SITEMGR_NAVBAR_EVENT)?></th>
				</tr>
				...
				while (($event = mysql_fetch_assoc($r)) && ($count<5)) {
					...
					$event_link = DEFAULT_URL."/".SITEMGR_ALIAS."/".EVENT_FEATURE_FOLDER."/view.php?id=".$event["id"];
					?>
					<tr>
	...
	if (BANNER_FEATURE == "on" && CUSTOM_BANNER_FEATURE == "on") {
		...
		$sql = "SELECT id, type, status, `caption` FROM Banner WHERE account_id = $id ORDER BY entered DESC";
		...
		if ($r && mysql_num_rows($r)>0) {
			...
			<table class="table-itemlist">
				...
				while (($banner = mysql_fetch_assoc($r)) && ($count<5)) {
					$count++;
					$banner_link = DEFAULT_URL."/".SITEMGR_ALIAS."/".BANNER_FEATURE_FOLDER."/view.php?id=".$banner["id"];
					?>
					<tr>
						<td>
	...
	?>
			...
			<table class="table-itemlist">
				...
				<tr>
					<th colspan="3"><span class="viewAllItems"><?=((mysql_num_rows($r)>5) ? "<a href='".DEFAULT_URL."/".SITEMGR_ALIAS."/".CLASSIFIED_FEATURE_FOLDER."/search.php?search_account_id=".$id."&search_submit=Search'>".ucfirst(system_showText(LANG_SITEMGR_MORE))." ".string_ucwords(system_showText(LANG_SITEMGR_CLASSIFIED_PLURAL))." &raquo;</a>" : "")?></span><?=string_ucwords(system_showText(LANG_SITEMGR_CLASSIFIED_PLURAL));?></th>
				</tr>
				...
				while (($classified = mysql_fetch_assoc($r)) && ($count<5)) {
					$count++;
					$classified_link = DEFAULT_URL."/".SITEMGR_ALIAS."/".CLASSIFIED_FEATURE_FOLDER."/view.php?id=".$classified["id"];
					?>
					<tr>
	...
	if (ARTICLE_FEATURE == "on" && CUSTOM_ARTICLE_FEATURE == "on") {
		...
		if ($r && mysql_num_rows($r)>0) {
			...
			<table class="table-itemlist">
				...
				<tr>
					<th colspan="2"><span class="viewAllItems"><?=((mysql_num_rows($r)>5) ? "<a href='".DEFAULT_URL."/".SITEMGR_ALIAS."/".ARTICLE_FEATURE_FOLDER."/search.php?search_account_id=".$id."&search_submit=Search'>".ucfirst(system_showText(LANG_SITEMGR_MORE))." ".string_ucwords(system_showText(LANG_SITEMGR_ARTICLE_PLURAL))." &raquo;</a>" : "")?></span><?=string_ucwords(system_showText(LANG_SITEMGR_ARTICLE_PLURAL))?></th>
				</tr>
				...
				while (($article = mysql_fetch_assoc($r)) && ($count<5)) {
					$count++;
					$article_link = DEFAULT_URL."/".SITEMGR_ALIAS."/".ARTICLE_FEATURE_FOLDER."/view.php?id=".$article["id"];
					?>
					<tr>
			...
			if (CUSTOM_INVOICE_FEATURE == "on") {
				...
				if ($r && mysql_num_rows($r)>0) {
					...
					<table class="table-itemlist">
						...
						<tr>
							<th colspan="4"><span class="viewAllItems"><?=((mysql_num_rows($r)>5) ? "<a href='".DEFAULT_URL."/".SITEMGR_ALIAS."/custominvoices/search.php?search_account_id=".$id."&search_submit=Search'>".ucfirst(system_showText(LANG_SITEMGR_MORE))." ".string_ucwords(system_showText(LANG_SITEMGR_CUSTOMINVOICE_PLURAL))." &raquo;</a>" : "")?></span><?=string_ucwords(system_showText(LANG_SITEMGR_CUSTOMINVOICE_PLURAL))?></th>
						</tr>
						...
						while (($custom_invoice = mysql_fetch_assoc($r)) && ($count<5)) {
							$count++;
							$custom_invoice_link = DEFAULT_URL."/".SITEMGR_ALIAS."/custominvoices/view.php?id=".$custom_invoice["id"];
							?>
							<tr>
