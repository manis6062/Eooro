<?
	...
	if (!isset($message)) system_setFreqActions('content_blog', 'BLOG_FEATURE');
    
    $whereContent = "section = 'blog'";
	...
	# PAGES DROP DOWN ----------------------------------------------------------------------------------------------
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/content/blog.php";
    ...
    <div id="main-right">
        ...
        <div id="top-content">
            <div id="header-content">
                <h1><?=string_ucwords(system_showText(LANG_SITEMGR_CONTENT_MANAGECONTENT))?> - <?=string_ucwords(system_showText(LANG_SITEMGR_BLOG))?></h1>
            </div>
        </div>
