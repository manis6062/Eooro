<?
	...
	// Page Browsing /////////////////////////////////////////
	$pageObj  = new pageBrowsing("Classified", $screen, RESULTS_PER_PAGE, ($_GET["newest"] ? "id DESC" : $manageOrder), "title", $letter, false, $fields);
	$classifieds = $pageObj->retrievePage();

	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/".CLASSIFIED_FEATURE_FOLDER."/index.php";
...
<div id="main-right">
	<div id="top-content">
		<div id="header-content"><h1><?=ucfirst(system_showText(LANG_SITEMGR_CLASSIFIED_PLURAL))?></h1></div>
	</div>
