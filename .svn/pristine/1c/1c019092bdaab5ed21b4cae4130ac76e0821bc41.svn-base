        ...
        <div id="footer" class="footer-wrapper">
            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    ...
                    <?// } ?>
                    -->
                    <div class="span<?=($setting_twitter_link ? "2" : "3")?> contact">
                    ...
                    <div class="span<?=($setting_twitter_link ? "2" : "3")?>">
                    ...
                    <div class="span3">
                        <?=htmlspecialchars_decode($setting_twitter_link);?>
                    </div>
                    <?php endif; ?>
                    <div class="span<?=( $setting_twitter_link ? 2 : 3)?>">
                    <?
                    ...
                    if ( $showFlags ):
                        ...
                        <ul class="nav">
                            <li><a rel="canonical" class="view-more" href="<?=LISTING_DEFAULT_URL."/".ALIAS_ALLLOCATIONS_URL_DIVISOR.".php"?>">View Locations</a></li>
                        </ul>
                    </div>
