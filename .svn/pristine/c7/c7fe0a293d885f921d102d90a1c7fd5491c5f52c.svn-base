<?
	...
	<div <?=$listing["id"] ? "id=\"listing_summary_".$listing["id"]."\"" : ""?> class="<?=$listing["backlink"] == "y" && BACKLINK_FEATURE == "on" ? "summary summary-backlink" : "summary" ?>">
		...
		<div class="left">
			...
			<div class="image <?=$removeFavoritesDivClass?>">
                <?=$removeFavoritesDiv;?>
            ...
            <div class="backlink-content">
                ...
                <div class="title">
                    ...
                    <h3>
                        <? if ((string_strpos($_SERVER["REQUEST_URI"], "results.php") !== false || string_strpos($_SERVER["REQUEST_URI"], ALIAS_LISTING_MODULE."/".ALIAS_CATEGORY_URL_DIVISOR."/") !== false || string_strpos($_SERVER["REQUEST_URI"], ALIAS_LISTING_MODULE."/".ALIAS_LOCATION_URL_DIVISOR."/") !== false) && GOOGLE_MAPS_ENABLED == "on" && $mapObj->getString("value") == "on") { ?>
