<?
	...
	*/
	$categoryDD = "<img class=\"loading_category\" src=\"".DEFAULT_URL."/theme/".EDIR_THEME."/images/iconography/icon-loading-footer.gif\" alt=\"".system_showText(LANG_WAITLOADING)."\"/>";
