...
<!--
    ...
    function doRefreshStatus() {
    	...
    	if (!blockRefresh) {
    		url = "<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/reports/statisticreport_refresh.php";
    ...
    function refreshStatusClose() {
    	$('#reportRefreshStatus').fadeOut(1000, function() {
    		<?
    		$url   = DEFAULT_URL.'/'.SITEMGR_ALIAS.'/reports/statisticreport.php';
    		// Query string
...
<div id="main-right">
    ...
    <div id="top-content">
        <div id="header-content">
            <h1><?=string_ucwords(system_showText(LANG_SITEMGR_NAVBAR_STATISTICREPORT))?></h1>
        </div>
    </div>
                                    ...
                                    <tr>
                                        <th class='highlight-subtitle-left'>
                                            <?
												...
												echo "http://".$domainObj->getString("url").EDIRECTORY_FOLDER;
											?>
                                        </th>
