		...
		<? } else {
				if (($onlyMainImage) || ($main == "false")) {
					...
					if ($uploadImageUpdate == "y") { ?>
						<script language="javascript" type="text/javascript">
							parent.loadGallery(<?=$_POST["item_id"]?>, 'y', '<?=SITEMGR_ALIAS?>', 'editFe', 'false');
							setTimeout(function(){
								parent.$.fancybox.close();
							}, 1500)
						</script>
					<? } elseif ($uploadImageUpdate == "n") { ?>
						<script language="javascript" type="text/javascript">
							parent.loadGallery(<?=$_POST["item_id"]?>, 'y', '<?=SITEMGR_ALIAS?>', 'n', 'false');
							setTimeout(function(){
								parent.$.fancybox.close();
							}, 1500)
						</script>
					...
					if (($uploadImageUpdate == "y") || ($uploadImageUpdate == "n")) { ?>
						<script language="javascript" type="text/javascript">
							parent.loadGallery(<?=$_POST["item_id"]?>, 'y', '<?=SITEMGR_ALIAS?>', '', 'true');
							setTimeout(function(){
								parent.$.fancybox.close();
							}, 1500)
						</script>
