...
?>
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="standard-table">
        <tr>
            <th colspan="2" class="standard-tabletitle"><?=system_showText(LANG_SITEMGR_CONTENT_HEADERLOGO)?>&nbsp;<span>( <?=IMAGE_HEADER_WIDTH?>px x <?=IMAGE_HEADER_HEIGHT?>px ) (JPG, GIF <?=system_showText(LANG_OR);?> PNG)</span></th>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                ...
                if (file_exists(EDIRECTORY_ROOT.IMAGE_HEADER_PATH)) {
                    ...
                    $headerlogo_path = "/images/content/img_logo.png";
                }
        ...
        <tr>
            <td colspan="2">
                ...
                if (file_exists(EDIRECTORY_ROOT.RSS_LOGO_PATH)) {
                    ...
                    $rsslogo_path = "/images/content/img_logo.png";
                }
        ...
        <tr>
            <td colspan="2">
                ...
                if (file_exists(EDIRECTORY_ROOT.MOBILE_LOGO_PATH)) {
                    ...
                    $mobilelogo_path = "/images/content/img_logo_mobile.png";
                }
