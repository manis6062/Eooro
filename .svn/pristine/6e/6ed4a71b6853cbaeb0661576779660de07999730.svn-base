<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/forms/form_blog_seocenter.php
	# ----------------------------------------------------------------------------------------------------
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var field_name = 'seo_abstract';
        var count_field_name = 'seo_abstract_remLen';
...
<table cellpadding="0" cellspacing="0" border="0" class="standard-table" style="margin-bottom: 0;">
	<tr>
		<th class="standard-tabletitle"><?=system_showText(LANG_LABEL_FRIENDLY_URL)?></th>
	</tr>
	<tr>
		<td class="standard-tableContent">
			<?=system_showText(LANG_MSG_FRIENDLY_URL1)?><br /><br /><strong><?=system_showText(LANG_LABEL_FOR_EXAMPLE)?>:</strong><br /><br /><?=system_showText(LANG_MSG_FRIENDLY_URL2)?><br />"<?=BLOG_DEFAULT_URL?>/john-auto-repair.html"
		</td>
	</tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0" class="standard-table">
    ...
    <tr>
        <td colspan="2">
            <textarea id="seo_abstract" name="seo_abstract" rows="5" cols="1" ><?=$seo_abstract;?></textarea>
        </td>
    </tr>
	<tr>
