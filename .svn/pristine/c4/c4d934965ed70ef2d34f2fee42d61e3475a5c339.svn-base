<?
    ...
    //Custom footer for each theme, if needed
    $footerThemePath = THEMEFILE_DIR."/".EDIR_THEME."/layout/members/footer.php";
    
    if (file_exists($footerThemePath)) {
        
        include($footerThemePath);
		...
		<div id="footer-wrapper">
			...
			<div id="footer">
				...
				<div class="right">
					...
					<? if (BRANDED_PRINT == "on") { ?>
						<h5 class="powered-by">Powered by <a href="http://www.edirectory.com<?=(string_strpos($_SERVER["HTTP_HOST"], ".com.br") !== false ? ".br" : "")?>" target="_blank">eDirectory Cloud Service</a>&trade;.</h5>
					<? } ?>
					<p class="copyright">
						<?=$footer?>
					</p>
