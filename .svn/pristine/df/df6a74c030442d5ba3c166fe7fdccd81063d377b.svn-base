...
<div class="submenu">
	<ul>
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/prefs/faq.php"><?=system_showText(LANG_SITEMGR_MANAGE)?></a></li>
		<li id="privateMenu_faq"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/prefs/faqadd.php"><?=system_showText(LANG_SITEMGR_MENU_ADD)?></a></li>
	</ul>
</div>
