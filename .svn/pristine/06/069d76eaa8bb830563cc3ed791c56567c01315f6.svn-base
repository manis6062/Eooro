	...
	if ($_location_father_level !== false ) { ?>
        ...
        if (string_strpos($url_base, "/".SITEMGR_ALIAS."")) { ?>
            ...
            <div class="bulkupdate-box">
                <a class="bulkUpdate" href="javascript:void(0)" onclick="showBulkUpdate( <?=RESULTS_PER_PAGE?>, 'location', '<?=system_showText(LANG_SITEMGR_CLOSE_BULK);?>', '<?=system_showText(LANG_SITEMGR_BULK_UPDATE);?>')" id="open_bulk">
        ...
        <div class="bulkupdate-box">
            ...
            <div class="bulkupdate-form">
                ...
                <form name="location_setting" id="location_setting" method="post" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>">
                    ...
                    <div id="table_bulk" style="display: none" class="table-bulkupdate">
                        ...
                        <button class="stmgr-btn" type="button" name="bt_operation_submit" id="bt_operation_submit" value="<?=system_showText(LANG_BUTTON_SUBMIT)?>" onclick="doSubmitChangeFather()"><?=system_showText(LANG_BUTTON_SUBMIT)?></button>
            ...
            <div id="bulk_check" style="display:none">
                ...
                <div class="bulk-checkall">
                    <input type="checkbox" id="check_all" name="check_all" onclick="checkAll('location', document.getElementById('check_all'), false, <?=$itemCount;?>);" />
                    
                    <a class="CheckUncheck" href="javascript:void(0);" onclick="checkAll('location', document.getElementById('check_all'), true, <?=$itemCount;?>);"><?=system_showText(LANG_CHECK_UNCHECK_ALL);?></a>
                </div>
