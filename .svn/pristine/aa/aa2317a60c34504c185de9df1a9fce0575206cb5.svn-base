<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /theme/realestate/body/article/index.php
	# ----------------------------------------------------------------------------------------------------
	...
	<div class="content-center">
        ...
        <div class="content">
            ...
            <div class="content-top">
                ...
                <? include(system_getFrontendPath("featured.php", "frontend", false, ARTICLE_EDIRECTORY_ROOT)); ?>
            </div>
            
            <div class="content-main">
                <? include(system_getFrontendPath("browsebycategory.php", "frontend", false, ARTICLE_EDIRECTORY_ROOT)); ?>
