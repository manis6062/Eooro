<?
	...
	//Advertise
	define("LANG_MENU_ADVERTISE", "Claim Your Business");
	//FAQ
	...
	//Enquire
	define("LANG_MENU_ENQUIRE", "Enquire");
	...
	//Classified Price
	define("LANG_LABEL_CLASSIFIED_PRICE", "Classified Price");
	//Event Time
	define("LANG_LABEL_EVENTTIME", "Event Time");
	//Imagery
	...
	define("LANG_LABEL_FORGOTPASSWORD", "Forgot password?");
	//Summary
    ...
    //Blog Comment
    define("LANG_LAVEL_BLOG_COMMENT", "Blog Comment");
	//Add
	...
	define("LANG_SITEMGR_CUSTOMPERIOD", "Custom Time Period");
        //For Twitter Feeds
        define("LANG_SITEMGR_TWITTER_FEED", "Twitter Feeds");
	...
	define("LANG_LABEL_DEALS_OFFER", "How many deals would you like to offer");
	//Linked to Listing
	...
	define("LANG_LABEL_FILTER_DEAL", "Show only ".LISTING_FEATURE_NAME_PLURAL." with deals");
	//maximum
	...
	//Use this field to enter a reference location of your item
	define("LANG_LABEL_LOCATIONS_TIP", "Use this field to enter a reference location of your item");
	...
	define("LANG_LABEL_NOTIFY_TRAFFIC_TIP", "Enable monthly e-mail to listing owners that includes their stats and reviews.");
	...
	define("LANG_LABEL_PROFILE_TIP", "Visitors can visit your frontend pages, write reviews, comment on blog and view other user's personal page. Visitors can upgrade their accounts by adding an item through the advertise process.");
	//Address (optional)
	...
	define("LANG_LABEL_MAP_NOTFOUND", "Not found. Your internet connection might be slow. Please, try to specify better your location.");
	...
	define("LANG_LABEL_PAYMENT_METHOD", "Payment Method");
        ...
        define("LANG_LABEL_PAYMENT_METHOD1", "Choose Payment Method");
	...
	//view full listing
	define("LANG_VIEW_LISTING", "view full listing");
	//view full article
	define("LANG_VIEW_ARTICLE", "view full article");
	//Go to Website
	...
	//Rate It!
	define("LANG_REVIEWRATEIT", "Review this Business");
	...
	//Send
	define("LANG_BUTTON_SEND", "Submit");
	//Sign Up
	...
	define("LANG_CAPTCHA_HELP", "Please check reCaptcha to continue. This is required to prevent automated submission of contact requests.");
    ...
    define("LANG_LABEL_SEARCHINGFOR", "Whose reviews are you looking for?");
    //Where?
	...
	//define("LANG_CATEGORIES_TITLE", "Categories and sub-categories");
        define("LANG_CATEGORIES_TITLE", "Categories");
	//Only select sub-categories that directly apply to your type.
	...
	//View Sample
	define("LANG_ADVERTISE_SAMPLE", "SEE EXAMPLE HERE");
	//Have any questions?
	...
	//changed text
        ...
        define("LANG_LISTINGINFO_TIP", "Insert the business name your customers will know.");
	...
	define("LANG_CLAIM_SIGNUP", "To claim this listing, just log in with your existing account details or create a new account.");
	//Listing Type
	...
	define("LANG_MSG_ACCOUNTLOCKED1", "Account locked. Wait");
        // Account not enabled msg
        define("LANG_MSG_ACCOUNTNOTENABLED", "Oops! You are still not active user. Please contact your business owner.");
        // Account not enabled msg
        define("LANG_MSG_ACCOUNTLOCKED3", "Oops! You are account is locked. Please contact your business owner.");
	//Account locked. Wait X "minute(s) and try again."
	...
	define("LANG_MSG_YOUDONTHAVEACCESSFROMTHISIPADDRESS", "You don't have access permission from this IP address!");
        ...
        //Sorry, your username/password/appid is incorrect.
	define("LANG_MSG_APP_WRONG_CREDINTIALS", "Sorry, your Business Id or Username or Password is incorrect.");
...
//Your account was deactivated!
	...
	//Daily Event
	define("LANG_DAILY2", "Daily ".ucwords(EVENT_FEATURE_NAME));
	//Weekly
	...
	//Deals bought
	define("LANG_LABEL_DEAL_BOUGHT", "Deals bought");
	//Deals left
	define("LANG_LABEL_DEAL_LEFT", "Deals left");
	//Left
	...
	define("LANG_MSG_NEED_LOGIN_DEAL", "You need to login to redeem a deal.");
	//No posts found.
    ...
    //Your blog post
    define("LANG_NOTIFY_NEWCOMMENT_1", "Your blog post");
    //has a new reply.
    ...
    define("LANG_NOTIFY_PREPAREIMPORT_EVENT", "Event Import Correction Notification");
    ...
    define("LANG_NOTIFY_IMPORTLISTING", "Listing Import Notification");
    //Your listing(s) import has been completed.
    define("LANG_NOTIFY_IMPORTLISTING_1", "Your listing(s) import has been completed.");
    //You can review the log here
    define("LANG_NOTIFY_IMPORTLISTING_2", "You can review the log here");
    //Event Import Notification
    define("LANG_NOTIFY_IMPORTEVENT", "Event Import Notification");
    //Your event(s) import has been completed
    define("LANG_NOTIFY_IMPORTEVENT_1", "Your event(s) import has been completed.");
    //You can review the log here
    ...
    define("LANG_NOTIFY_SIGNUPLISTING", "New User Signup (Listing)");
    //A new user has signed up and ordered a listing at ".EDIRECTORY_TITLE.".
    define("LANG_NOTIFY_SIGNUPLISTING_1", "A new user has signed up and ordered a listing at ".EDIRECTORY_TITLE.".");
    //New User Signup (Event)
    define("LANG_NOTIFY_SIGNUPEVENT", "New User Signup (Event)");
    //A new user has signed up and ordered an event at ".EDIRECTORY_TITLE.".
    define("LANG_NOTIFY_SIGNUPEVENT_1", "A new user has signed up and ordered an event at ".EDIRECTORY_TITLE.".");
    //New User Signup (Classified)
    define("LANG_NOTIFY_SIGNUPCLASSIFIED", "New User Signup (Classified)");
    //A new user has signed up and ordered a classified at ".EDIRECTORY_TITLE.".
    define("LANG_NOTIFY_SIGNUPCLASSIFIED_1", "A new user has signed up and ordered a classified at ".EDIRECTORY_TITLE.".");
    //New User Signup (Banner)
    define("LANG_NOTIFY_SIGNUPBANNER", "New User Signup (Banner)");
    //A new user has signed up and ordered a banner at ".EDIRECTORY_TITLE.".
    define("LANG_NOTIFY_SIGNUPBANNER_1", "A new user has signed up and ordered a banner at ".EDIRECTORY_TITLE.".");
    //New User Signup (Article)
    define("LANG_NOTIFY_SIGNUPARTICLE", "New User Signup (Article)");
    //A new user has signed up and ordered an article at ".EDIRECTORY_TITLE.".
    define("LANG_NOTIFY_SIGNUPARTICLE_1", "A new user has signed up and ordered an article at ".EDIRECTORY_TITLE.".");
    //Listing Claimed!
    define("LANG_NOTIFY_NEWCLAIM", "Listing Claimed!");
    ...
    define("LANG_NOTIFY_NEWCLAIM_4", "To preview the listing, follow the listing link below");
    ...
    define("LANG_NOTIFY_NEWCLAIM_6", "Account Details for the listing owner");
	...
	define("LANG_NOTIFY_NEWLEAD", "You received a new lead through the enquire form. To view the lead, follow the link below.");
    ...
    define("LANG_MOBILE_RECENT_LISTINGS", "Recently added listings");
    //View full site
	...
	//Keyword to search...
	define("LANG_LABEL_KEYWORDSEARCH", "Enter business name ..");
	//Location to search...
	...
	//Offers & Deals
	define("LANG_LABEL_DEAL_FILTER", "Offers & Deals");
	//Cuisine
	...
	//No record found.
	define("LANG_NORECORD", "No record found.");
	//Forward
	...
	//New Enquire
	define("LANG_LEAD_ENQUERY", "New Enquire");
	//General Lead
    ...
    //Deal not linked
    define("LANG_LABEL_NOTLINKED", "Deal not linked");
    //Increase Visibility
    ...
    //Add photos or video
    define("LANG_LABEL_GAMEFY_MEDIA", "Add logo or videos");
    //Add details
    define("LANG_LABEL_GAMEFY_ADDITIONAL", "Add social media description");
	...
	define("LANG_LABEL_PROFILE_TIP2", "Thank you for being part of ".EDIRECTORY_TITLE.". Join our community by giving your opinion and evaluating your favorite listings.");
	//Oh wait...
	...
	define("LANG_LABEL_PROFILE_TIP4", "This user has no activity in our portal yet.<br>Don't worry. You can still join our community by giving your opinion and evaluating your favorite listings.");
	//Rated
	define("LANG_LABEL_RATED", "Rated");
	//Commented
	define("LANG_LABEL_COMMENTED", "Commented");
	//Redeemed deal
	define("LANG_LABEL_REDEEMED", "Redeemed deal");
	//Your redeem code is 
