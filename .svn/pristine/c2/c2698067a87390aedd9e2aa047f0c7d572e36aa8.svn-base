...
?>
    ...
    <div class="tip-base">
        ...
        <p style="text-align: justify;">1) <?=system_showText(LANG_SITEMGR_API_TIP3)?></p>
        <p style="text-align: justify;">2) <?=system_showText(LANG_SITEMGR_API_TIP4)?></p>
        <br />
        <p><?=system_showText(DEFAULT_URL."/API/api.php?key=[".LANG_SITEMGR_API_TIP6."]&module=[".LANG_SITEMGR_API_TIP7."]&keyword=[".LANG_SITEMGR_API_TIP8."]")?></p>
        <br />
    ...
    <p><?=system_showText(LANG_SITEMGR_API_NOTE);?></p>