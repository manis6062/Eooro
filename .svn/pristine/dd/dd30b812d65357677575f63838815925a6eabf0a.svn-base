<?
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="standard-table">
        <tr class="bigger">
            <th><i><span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_PROMOTION_TITLE)?>:</th>
            <td>
...
<? //////////////////////////////////////////////////////////////////////////////////// ?>
        ...
        <tr>
            ...
            <td id="listingContent">
                <? if ($aux_listing_title) { ?>
                    <a href="javascript:void(0);" onclick="showSearchListing('show');" id="aux_listing_title"><?=$aux_listing_title;?></a>
                <? } ?>
                <div id="listing_title_div">
                    <input type="text" name="listing_title" value="<?=($aux_listing_title ? htmlspecialchars($aux_listing_title) : "")?>" id="listing_title" style="display:<?=($aux_listing_id ? "none" : "block")?>"/>
                </div>
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="standard-table">
        <tr>
            ...
            <td>
                <textarea id="promotiondesc" <?=($highlight == "description" && !$description ? "class=\"highlight\"" : "")?> name="description" rows="5" cols="1"><?=$description;?></textarea>
            </td>
        </tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="standard-table">
        ...
        <tr>
            ...
            <td>
                <textarea id="conditions" <?=($highlight == "description" && !$conditions ? "class=\"highlight\"" : "")?> name="conditions" rows="5" cols="1"><?=$conditions;?></textarea>
            </td>
        </tr>
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="standard-table noBackground">
        ...
        <tr>
            <th class="alignTop" style="padding-left:20px;">
                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_LABEL_START_DATE)?>:
            </th>
            <td>
                <input type="text" name="start_date" id="start_date" value="<?=$start_date?>" style="width:85px" /><span> (<?=format_printDateStandard()?>)</span>
            </td>
            <th class="alignTop">
                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_LABEL_END_DATE)?>:
            </th>
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="standard-table noBackground" style="display:none;">
        <tr>
        ...
        <tr>
            <th class="table-subtitle" colspan="4">
                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_SITEMGR_DEALSHOWUP)?> <?=system_showText(LANG_SITEMGR_DEALSEARCHES_NEARBY)?>.
            </th>
        </tr>
        <tr>
                    ...
                    <table>
                        <tr>
                            <th class="alignTop auto-size">
                                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_LABEL_START_TIME)?>:
                            </th>
                            <td>
                        ...
                        <tr>
                            <th class="alignTop auto-size">
                                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_LABEL_END_TIME)?>:
                            </th>
                            <td>
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="standard-table noBackground">
        ...
        <tr>
            <th class="table-subtitle" colspan="4">
                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_MSG_ADD_DEAL_TIP)?>
            </th>
        </tr>
            ...
            <td class="table-column">
                <div class="table-box table-box-small">
                    <table>
                        <tr>
                            <th>
                                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_SITEMGR_ITEMVALUE)?> (<?=CURRENCY_SYMBOL?>):
                            </th>
                            <td>
                                <input type="text" id="real_price_int" name="real_price_int" value="<?=$price_value[0]?>" onkeyup="calculateDiscount();" maxlength="5" style="width:75px; text-align:right;"/>
                                <strong> &nbsp;.&nbsp; </strong>
                                <input type="text" id="real_price_cent" name="real_price_cent" value="<?=$price_value[1]?>" onkeyup="calculateDiscount();" maxlength="2" style="width:40px;" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2" class="center-info">
                                <label>
                                    <input type="radio" id="type_monetary" name="deal_type" value="monetary value" class="inputCheck" <?=((!$deal_type || $deal_type == "monetary value") ? "checked=true" : "")?> onclick="showAmountType('<?=CURRENCY_SYMBOL?>','not');" /> 
                                ...
                                <label>
                                    <input type="radio" id="type_percentage" name="deal_type" value="percentage" class="inputCheck" <?=(($deal_type == "percentage") ? "checked=true" : "")?> onclick="showAmountType('%','not');" /> 
                        ...
                        <tr>
                            <th>
                                <i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_LABEL_DISC_AMOUNT)?>
                            ...
                            <td> 
                                ...
                                ?>
                                <input type="text" id="deal_price_int" name="deal_price_int" value="<?=$price_value[0]?>" onkeyup="calculateDiscount();" <?=(($deal_type == "percentage") ? "maxlength=\"2\"" : "maxlength=\"5\"")?> style="width:75px; text-align:right;" />
                                <label id="label_deal_cent">
                                    <strong> &nbsp;.&nbsp; </strong>
                                    <input type="text" id="deal_price_cent" name="deal_price_cent" value="<?=$price_value[1]?>" onkeyup="calculateDiscount();" maxlength="2" style="width:40px;" />
                                </label>
                        ...
                        <tr>
                            <th><i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i> <?=system_showText(LANG_LABEL_DEALS_OFFER)?>:</th>
                            <td> 
                               <input type="text" name="amount" id="amount" style="width:55px;" maxlength="10" value="<?=(int)$amount?>">
                                ...
                                if ($dealInfo['sold']){
                                    ?>
                                    <span><i> * <span><?=system_showText(LANG_LABEL_REQUIRED_FIELD);?></span></i><?=$dealInfo['sold']?> <?=$dealInfo['sold']>1? system_showText(LANG_SITEMGR_DONEUNTIL_PLURAL) : system_showText(LANG_SITEMGR_DONEUNTIL_SINGULAR)?>.</span>
                                    <?
                                }
                                ?>
                            </td>
            ...
            if ($imageObj->imageExists()) {
                ...
                <tr>
                    ...
                    <td class="image-space" colspan="2">
                        <?=$imageObj->getTag(true, IMAGE_PROMOTION_THUMB_WIDTH, IMAGE_PROMOTION_THUMB_HEIGHT, $promotion->getString("name", false));?>
                    </td>
                </tr>
                <?
            }
