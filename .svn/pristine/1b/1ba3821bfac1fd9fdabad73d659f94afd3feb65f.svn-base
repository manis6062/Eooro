<?
	...
	# ----------------------------------------------------------------------------------------------------
	# * FILE: /includes/views/view_listing_summary_code_diningguide.php
	# ----------------------------------------------------------------------------------------------------
    ...
    <div <?=$listing["id"] ? "id=\"summary_map_content_".$listing["id"]."\"" : ""?>>
        ...
        <div <?=$listing["id"] ? "id=\"listing_summary_".$listing["id"]."\"" : ""?> class="summary-small <?=$listing["backlink"] == "y" && BACKLINK_FEATURE == "on" ? "summary summary-backlink" : "summary" ?>">
            ...
            <div class="row-fluid title">
                ...
                <div class="<?=(($listing_deal && $listingtemplate_price) ? "span8" : (($listing_deal || $listingtemplate_price) ? "span10" : "span12"))?>" >
                    <h3>
                ...
                <div class="pull-right summary-price">
                    <?=system_showText(LANG_LABEL_PRICE_RANGE);?>:
                    <a href="javascript:void(0);" title="<?=($listing_price_symbol." ".$listingtemplate_price);?>" <?=(!$user ? "style=\"cursor: default;\"" : "")?>><?=$listingtemplate_price_symbol;?></a>
                </div>
            ...
            <div class="row-fluid line-footer">
                ...
                <div class="icons text-right">
                    ...
                    <div class="navicons"><?=$listingtemplate_icon_navbar?></div>
