<?
    ...
    # ----------------------------------------------------------------------------------------------------
    # * FILE: /sitemgr/blog/comments/status.php
    # ----------------------------------------------------------------------------------------------------
    ...
    if (string_strpos($_SERVER["HTTP_REFERER"], "view.php")) {
        ...
        header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".BLOG_FEATURE_FOLDER."/comments/view.php".$response);
    } else {
		if ($is_reply) {
        ...
        header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".BLOG_FEATURE_FOLDER."/comments/index.php".$response);
    }
    exit;