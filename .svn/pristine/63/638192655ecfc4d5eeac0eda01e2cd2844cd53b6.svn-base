<?
    ...
    # ----------------------------------------------------------------------------------------------------
    # * FILE: /theme/contractors/layout/header.php
    # ----------------------------------------------------------------------------------------------------
        ...
        <div class="navbar navbar-static-top">
            ...
            <div class="header-brand container">
                ...
                <div class="side-header">
                    ...
                    if ($front_text_top && string_strpos($_SERVER["REQUEST_URI"], ALIAS_ADVERTISE_URL_DIVISOR.".php") === false) { ?>
                        <div class="flex-box-inline">
                            <h5>
                                <b><?=$front_text_top;?></b>
                            </h5>
                            <a class="inline-block" href="<?=NON_SECURE_URL?>/<?=ALIAS_ADVERTISE_URL_DIVISOR?>.php"><?=system_showText(LANG_LABEL_LEARN_MORE);?> »</a>
                        </div>
                    <? } ?>
