				...
				if ($i > 0) {
					if (strlen($sqlBlock) == 0 && strlen($sqlLine) == 0) {
						if ($type != "listing"){ //working only for Event
							$sqlLine = "INSERT INTO `ImportTemporary_".ucfirst($type)."` (`id`, `import_log_id`, `file_line_number`, `error`, `account_username`, `account_password`, `account_first_name`, `account_last_name`, `account_company`, `account_address`, `account_address2`, `account_country`, `account_state`, `account_city`, `account_zip`, `account_phone`, `account_fax`, `account_email`, `account_url`, `".$type."_id`, `".$type."_title`, `".$type."_seo_title`, `".$type."_email`, `".$type."_url`, `".$type."_address`, `".$type."_locationname`, `".$type."_contactname`, `".$type."_startdate`, `".$type."_enddate`, `".$type."_starttime`, `".$type."_starttime_mode`, `".$type."_endtime`, `".$type."_endtime_mode`, `".$type."_location1`, `".$type."_location1_abbreviation`, `".$type."_location2`, `".$type."_location2_abbreviation`, `".$type."_location3`, `".$type."_location3_abbreviation`, `".$type."_location4`, `".$type."_location4_abbreviation`, `".$type."_location5`, `".$type."_location5_abbreviation`, `".$type."_zip`, `".$type."_latitude`, `".$type."_longitude`, `".$type."_phone`, `".$type."_description`, `".$type."_long_description`, `".$type."_seo_description`, `".$type."_keyword`, `".$type."_renewal_date`, `".$type."_status`, `".$type."_level`, `".$type."_category_1`, `".$type."_category_2`, `".$type."_category_3`, `".$type."_category_4`, `".$type."_category_5`, `custom_id`) VALUES ";
						} else {
							$sqlLine = "INSERT INTO `ImportTemporary` (`id`, `import_log_id`, `file_line_number`, `error`, `account_username`, `account_password`, `account_first_name`, `account_last_name`, `account_company`, `account_address`, `account_address2`, `account_country`, `account_state`, `account_city`, `account_zip`, `account_phone`, `account_fax`, `account_email`, `account_url`, `listing_id`, `listing_title`, `listing_seo_title`, `listing_email`, `listing_url`, `listing_address`, `listing_address2`, `listing_location1`, `listing_location1_abbreviation`, `listing_location2`, `listing_location2_abbreviation`, `listing_location3`, `listing_location3_abbreviation`, `listing_location4`, `listing_location4_abbreviation`, `listing_location5`, `listing_location5_abbreviation`, `listing_zip`, `listing_latitude`, `listing_longitude`, `listing_phone`, `listing_fax`, `listing_description`, `listing_long_description`, `listing_seo_description`, `listing_keyword`, `listing_renewal_date`, `listing_status`, `listing_level`, `listing_category_1`, `listing_category_2`, `listing_category_3`, `listing_category_4`, `listing_category_5`, `listing_template`, `custom_id`) VALUES ";
						}
