<?
	...
	if ($wp_enabled == "on"){
		header("Location: ".DEFAULT_URL."/".SITEMGR_ALIAS."/".BLOG_FEATURE_FOLDER."/index.php");
	}
		...
		<div class="default-margin">
			...
			<div class="baseForm">
                ...
                <form name="blog" id="blog" action="<?=system_getFormAction($_SERVER["PHP_SELF"])?>" method="post" enctype="multipart/form-data">
                    ...
                    <? include(INCLUDES_DIR."/forms/form_blog.php"); ?>
                ...
                <form id="formblogcancel" action="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/<?=BLOG_FEATURE_FOLDER;?>/<?=(($search_page) ? "search.php" : "index.php");?>" method="get">
