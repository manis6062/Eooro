<?
    ...
    <table border="0" cellpadding="2" cellspacing="0" class="standard-table">
        ...
        <tr>
            <? if (string_strpos($_SERVER["PHP_SELF"], "/".SITEMGR_ALIAS."/manageaccount.php")!==false) { ?>
                <th class="alignTop alignWithField"><?=system_showText(LANG_SITEMGR_LABEL_CURRENTPASSWORD)?>:</th>
                <td>
                    <input type="password" name="current_password" class="input-form-account med" />
        ...
        <tr>
            ...
            <td>
                <input type="password" name="password" maxlength="<?=PASSWORD_MAX_LEN?>" class="input-form-account med" onkeyup="checkPasswordStrength(this.value, '<?=EDIRECTORY_FOLDER;?>')" />
        ...
        <tr>
            ...
            <td><input type="password" name="retype_password" class="input-form-account med" /></td>
        </tr>
    ...
    <em class="informationRequired">* <?=system_showText(LANG_LABEL_REQUIRED_FIELD)?></em>  
