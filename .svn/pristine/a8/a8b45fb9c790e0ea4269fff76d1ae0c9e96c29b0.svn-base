<?
	...
	<table class="table-itemlist">
		<tr>
			<th><?=system_showText(LANG_SITEMGR_CRONJOBREPORT_LABEL_CRONJOB);?></th>
			<th><?=system_showText(LANG_SITEMGR_CRONJOBREPORT_LABEL_PERIOD);?></th>
			<th><?=system_showText(LANG_SITEMGR_CRONJOBREPORT_LABEL_UPDATED);?></th>
		</tr>
		<tr>
