<?
	...
	# PAGE BROWSING
	# ----------------------------------------------------------------------------------------------------
	$pageObj  = new pageBrowsing("Content", $screen, RESULTS_PER_PAGE, "id", "id", $letter, "section = 'client'");
	$contents = $pageObj->retrievePage();

	# PAGES DROP DOWN ----------------------------------------------------------------------------------------------
	$paging_url = DEFAULT_URL."/".SITEMGR_ALIAS."/content/client.php";
    ...
    <div id="main-right">
        ...
        <div id="content-content">
            ...
            <div class="default-margin">
                ...
                <ul class="list-view">
                    <li><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/content/custom.php"><?=system_showText(LANG_SITEMGR_CONTENT_ADDCUSTOMWEBPAGE)?> &raquo;</a></li>
                </ul>
