    ...
    if ($acc_id) {
        ...
        ******************************************************/
        ...
        if ($emailNotificationObj = system_checkEmail(SYSTEM_ACTIVATE_ACCOUNT)) {
            ...
            $return = system_mail($contact->getString("email"), $subject, $body, EDIRECTORY_TITLE." <$sitemgr_email>", $emailNotificationObj->getString("content_type"), "", $emailNotificationObj->getString("bcc"), $error, "", "", "", "", $acc_id, SYSTEM_ACTIVATE_ACCOUNT);
