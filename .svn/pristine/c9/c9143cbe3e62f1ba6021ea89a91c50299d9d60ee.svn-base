                    ...
                    if (geocoder) {
                        geocoder.geocode( { 'address': address}, function(results, status) {
                            if (status != google.maps.GeocoderStatus.OK) {
                                 $("#zipnotfound").show();
                                // fancy_alert("<?=system_showText(LANG_LABEL_MAP_NOTFOUND)?>", "errorMessage", false, 300, 90, false);
                            }
                            if (status == google.maps.GeocoderStatus.OK) {
        ...
        function loadMap(form, use_lat_long){
            ...
            if (use_lat_long && latitude && longitude){
                ...
                if (document.getElementById('location_4')) {
                    index = document.getElementById('location_4').selectedIndex;
...
//                        callMap = true;
//                    }
                    if (document.getElementById('input_location_4').value) {
                        location_4 = document.getElementById('input_location_4').value;
                        locations[array_index] = location_4;
                        array_index++;
                        callMap = true;
                    }
...
//                    index = document.getElementById('location_3').selectedIndex;
...
//                        callMap = true;
//                    }
                    if (document.getElementById('input_location_3').value) {
                        location_3 = document.getElementById('input_location_3').value;
                        locations[array_index] = location_3;
                        array_index++;
                        callMap = true;
                    }
...
//                    index = document.getElementById('location_1').selectedIndex;
...
//                        callMap = true;
//                    }
                    if (document.getElementById('input_location_1').value) {
                        location_1 = document.getElementById('input_location_1').value;
                        locations[array_index] = location_1;
                        array_index++;
                        callMap = true;
                    }
