...
<br />
<div class="tip-base">
	<p style="text-align: justify;"><a href="<?=DEFAULT_URL;?>/<?=SITEMGR_ALIAS?>/faq/faq.php?keyword=<?=urlencode("badges");?>" target="_blank"><?=system_showText(LANG_SITEMGR_SETTINGS_EDITORCHOICE_TIP)?></a></p>
</div>
<br />
			...
			<td align="left" class="td-form">
				...
				<? if (($hasImage) || ($default_name[$i])) { ?>
					...
					<table border="0" cellpadding="0" cellspacing="0" style=" width: auto;">
						<tr>
							<td style="padding: 2px;"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/prefs/editorchoice.php?delete=y&id=<?=$default_editor_id[$i]?>" title="<?=system_showText(LANG_SITEMGR_SETTINGS_EDITORCHOICE_CLICKHERETODELETECHOICE)?> <?=$i+1?>" style="line-height: 13px; color: #CC0000; font-weight: bold;"><img src="<?=DEFAULT_URL?>/images/bt_delete.gif" alt="delete" title="delete" border="0" /></a></td>
							<td style="padding: 2px;"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/prefs/editorchoice.php?delete=y&id=<?=$default_editor_id[$i]?>" title="<?=system_showText(LANG_SITEMGR_SETTINGS_EDITORCHOICE_CLICKHERETODELETECHOICE)?> <?=$i+1?>" style="line-height: 13px; color: #CC0000; font-weight: bold;"> <?=string_strtolower(system_showText(LANG_SITEMGR_DELETE))?></a></td>
						</tr>
					</table>
