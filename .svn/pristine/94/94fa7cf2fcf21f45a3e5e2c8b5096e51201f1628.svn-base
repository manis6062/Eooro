<?
    ...
    $thePageTitle = '<h1 class="transparent-bg">Terms of Use</h1>';
	...
	$sql = "SELECT content from {$dbDomain->db_name}.Content where type = 'Terms of Use'";
...
<ol itemscope itemtype="http://schema.org/BreadcrumbList" class="hidden">
		  <li itemprop="itemListElement" itemscope
		    ...
		    <a itemprop="item" href="<?=NON_SECURE_URL?>/termsofuse.php">
