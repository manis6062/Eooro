...
<div class="submenu">
	<ul>
		...
		<li id="privateMenu_home"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/claim/"><?=string_ucwords(system_showText(LANG_SITEMGR_MENU_CLAIMSHOME))?></a></li>
		<li id="privateMenu_search"><a href="<?=DEFAULT_URL?>/<?=SITEMGR_ALIAS?>/claim/search.php"><?=system_showText(LANG_SITEMGR_MENU_SEARCH)?></a></li>
