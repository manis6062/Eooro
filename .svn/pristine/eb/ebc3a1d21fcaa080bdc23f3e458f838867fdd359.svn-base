...
<table cellpadding="2" cellspacing="0" border="0" class="table-form">
	...
	<tr class="tr-form">
		<td align="right" class="td-form">
			<div class="label-form">
				<?=system_showText(LANG_SITEMGR_LABEL_STATE)?>:
			</div>
		</td>
		<td align="left" class="td-form">
	...
	<tr class="tr-form">
		<td align="right" class="td-form">
			<div class="label-form">
				<?=system_showText(LANG_LABEL_INVOICELOGO)?> <span style="font-size: 9px;">(<?=IMAGE_INVOICE_LOGO_WIDTH?>px x <?=IMAGE_INVOICE_LOGO_HEIGHT?>px):</span><br /><br />
			</div>
		</td>
		<td align="left" class="td-form">
		...
		<tr class="imageSpace">
			<td colspan="2">
				...
				if ($imageObj->imageExists()) {
					echo $imageObj->getTag(true, IMAGE_INVOICE_LOGO_WIDTH, IMAGE_INVOICE_LOGO_HEIGHT, system_showText(LANG_LABEL_INVOICELOGO));
				}
				?>
			</td>
		</tr>
