        ...
        $.fn.formbuilder = function (options) {
                ...
                return this.each(function () {
                        ...
                        var controlBox = function (target) {
                                        ...
                                        box_content_bottom = '<select id="' + box_id_bottom + '" class="frmb-control">' + select + '</select>';
                                        save_button = '<input type="submit" id="' + save_id + '" class="frmb-submit" value="' + opts.messages.save + '"/>';
                                        preview_button = '<input type="button" id="' + preview_id + '" class="frmb-submit" value="' + opts.messages.preview + '"/>';
                                        ...
                                        div_options = '<div id="div_options" style="display:none">' + box_content_bottom + save_button + preview_button + '</div>';
//                                        //Add select again
...
//                                        $(ul_obj).after(preview_button);
                                        ...
                                        $('#' + preview_id).click(function () {
                                                if ($("#livemode").val() == 1) {
                                                    livemodeMessage($("#livemode_msg").val());
                                                } else {
                                                    save(false);
