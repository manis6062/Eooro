...
?>
    ...
    <div class="modal-content <?=$extraStyle?>">
                    ...
                    <? if(!$item_error && !$return_email_message) { ?>
                        ...
                        <div class="left">
                            ...
                            <div>
                                ...
                                <input type="text" name="from" value="<?=($receiver == "owner" && sess_getAccountIdFromSession() && is_object($userInfo) && !$_POST) ? ($userInfo->getString("email")) : ($from)?>" class="text" />
                            </div>
        ...
        if ($pop_type == "profile_login" && $_GET["auto"]) { ?>
