				...
				for($j=0;$j<count($array_package_items);$j++){
					...
					if($aux_domainObj->getString("status") == "A" || $aux_domainObj->getString("status") == "P"){
						...
						if($array_package_items[$j]["module"] == "listing"){
							...
							$itemMailLink .= "<a href=\"".$domain_url."/".SITEMGR_ALIAS."/".LISTING_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."\" target=\"_blank\">".$domain_url."/".SITEMGR_ALIAS."/".LISTING_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."</a><br /><br />";
						}
						...
						if($array_package_items[$j]["module"] == "event"){
							...
							$itemMailLink .= "<a href=\"".$domain_url."/".SITEMGR_ALIAS."/".EVENT_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."\" target=\"_blank\">".$domain_url."/".SITEMGR_ALIAS."/".EVENT_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."</a><br /><br />";
						}
						...
						if($array_package_items[$j]["module"] == "article"){
							...
							$itemMailLink .= "<a href=\"".$domain_url."/".SITEMGR_ALIAS."/".ARTICLE_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."\" target=\"_blank\">".$domain_url."/".SITEMGR_ALIAS."/".ARTICLE_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."</a><br /><br />";
						}
						...
						if($array_package_items[$j]["module"] == "classified"){
							...
							$itemMailLink .= "<a href=\"".$domain_url."/".SITEMGR_ALIAS."/".CLASSIFIED_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."\" target=\"_blank\">".$domain_url."/".SITEMGR_ALIAS."/".CLASSIFIED_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."</a><br /><br />";
						}
						...
						if($array_package_items[$j]["module"] == "banner"){
							...
							$itemMailLink .= "<a href=\"".$domain_url."/".SITEMGR_ALIAS."/".BANNER_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."\" target=\"_blank\">".$domain_url."/".SITEMGR_ALIAS."/".BANNER_FEATURE_FOLDER."/view.php?id=".$aux_item_object->getNumber("id")."</a><br /><br />";
						}
						...
						if($array_package_items[$j]["module"] == "custom_package"){
							...
							if ($members){ 
								...
								if ($array_package_items[$j]["price"]>0){
									...
									$itemMailLink .= "/".SITEMGR_ALIAS."/custominvoices/view.php?id=".$customInvoiceObj->getNumber("id");
									$itemMailLink .= "<br />";
									...
									$error = false;
									system_mail($contactObj->getString("email"), $subject, $body, EDIRECTORY_TITLE." <$sitemgr_email>", $emailNotification->getString("content_type"), "", $emailNotification->getString("bcc"), $error, "", "", "", "", $contactObj->account_id, SYSTEM_NEW_CUSTOMINVOICE);
